...
\begin{proof}
    $(c)$ The two maps $h_{S^n},\ g_{S^n}$ trivially agree up to sign, for they
...
\begin{proof}    
    ...
    Since $X$ is a pointed connected space, by~\cite[thm. 12.1]{HM19} and the
    ...
    $(C_\bullet,\partial)$, where $C_0=\Z$, $C_n=\Z$, $C_{n+1}$, $C_t=0$ for
