...
\begin{proof}
    ...
    [\gamma*\alpha*\gamma^{-1}]$ is continuous.
    
    Since homotopy relations are
    preserved by compositions among continuous maps, we may define the action of
    $[\alpha]\in\pi_1(B,b_0)$ on $\pi_n(\Omega B,[const_{b_0}])$ by defining, for
